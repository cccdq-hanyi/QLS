# 1 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
...
# 1 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
# 16 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
...
# 17 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c" 2
...
# 18 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c" 2
...
# 19 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c" 2
...
static FMSTR_APPCMD_CODE pcm_nAppCmd;
static FMSTR_APPCMD_DATA pcm_pAppCmdBuff[32];
static FMSTR_SIZE pcm_nAppCmdLen;

static FMSTR_APPCMD_RESULT pcm_nAppCmdResult;
static FMSTR_SIZE8 pcm_nAppCmdResultDataLen;


static FMSTR_APPCMD_CODE pcm_pAppCmdCallId[4];
static FMSTR_PAPPCMDFUNC pcm_pAppCmdCallFunc[4];
...
void FMSTR_InitAppCmds(void)
{
    ...
    for(i=0; i<4; i++)
    {
        pcm_pAppCmdCallId[i] = 0xffU;
        pcm_pAppCmdCallFunc[i] = ((void *) 0);
    }


    pcm_nAppCmd = (FMSTR_APPCMD_CODE) 0xffU;
    pcm_nAppCmdResult = (FMSTR_APPCMD_RESULT) 0xffU;
}
# 77 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
FMSTR_BPTR FMSTR_StoreAppCmd(FMSTR_BPTR pMessageIO)
{
    ...
    if(pcm_nAppCmd != ((FMSTR_APPCMD_CODE) 0xffU))
    {
        return ( (*((FMSTR_U8*)(pResponse)) = (FMSTR_U8)(0x87U)), (((FMSTR_BPTR)(pResponse))+1) );
    }

    pMessageIO = ( ((FMSTR_BPTR)(pMessageIO)) + (1U) );
    pMessageIO = ( (*((FMSTR_U8*)(&nArgsLen)) = *(FMSTR_U8*)(pMessageIO)), (((FMSTR_BPTR)(pMessageIO))+1) );
    pMessageIO = ( (*((FMSTR_U8*)(&nCode)) = *(FMSTR_U8*)(pMessageIO)), (((FMSTR_BPTR)(pMessageIO))+1) );


    nArgsLen--;


    if (nArgsLen > (FMSTR_SIZE8) 32)
    {
        return ( (*((FMSTR_U8*)(pResponse)) = (FMSTR_U8)(0x85U)), (((FMSTR_BPTR)(pResponse))+1) );
    }
    ...
    if(nArgsLen)
    {
        ...
        ( appCmdBuffAddr = (FMSTR_ADDR) (FMSTR_U8*) pcm_pAppCmdBuff );
    ...
    pcm_nAppCmdResult = (FMSTR_APPCMD_RESULT) 0xfeU;
    pcm_nAppCmdResultDataLen = 0U;

    return ( (*((FMSTR_U8*)(pResponse)) = (FMSTR_U8)(0x00U)), (((FMSTR_BPTR)(pResponse))+1) );
}
# 138 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
FMSTR_BPTR FMSTR_GetAppCmdStatus(FMSTR_BPTR pMessageIO)
{

    FMSTR_PAPPCMDFUNC pFunc = ((void *) 0);
    FMSTR_INDEX nIndex;
    ...
    return ( (*((FMSTR_U8*)(pMessageIO)) = (FMSTR_U8)((FMSTR_U8) pcm_nAppCmdResult)), (((FMSTR_BPTR)(pMessageIO))+1) );
}
# 176 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
FMSTR_BPTR FMSTR_GetAppCmdRespData(FMSTR_BPTR pMessageIO)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_U8 nDataLen;
    ...
    pMessageIO = ( ((FMSTR_BPTR)(pMessageIO)) + (1U) );
    pMessageIO = ( (*((FMSTR_U8*)(&nDataLen)) = *(FMSTR_U8*)(pMessageIO)), (((FMSTR_BPTR)(pMessageIO))+1) );
    pMessageIO = ( (*((FMSTR_U8*)(&nDataOffset)) = *(FMSTR_U8*)(pMessageIO)), (((FMSTR_BPTR)(pMessageIO))+1) );


    if(nDataLen > (FMSTR_U16)(((8)*5)+18+2))
    {
    ...
    {
        return ( (*((FMSTR_U8*)(pResponse)) = (FMSTR_U8)(0x86U)), (((FMSTR_BPTR)(pResponse))+1) );
    }
...
# 226 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
static FMSTR_INDEX FMSTR_FindAppCmdCallIndex(FMSTR_APPCMD_CODE nAppcmdCode)
{
...
# 255 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
void FMSTR_AppCmdAck(FMSTR_APPCMD_RESULT nResultCode)
{
...
# 273 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
void FMSTR_AppCmdSetResponseData(FMSTR_ADDR nResultDataAddr, FMSTR_SIZE nResultDataLen)
{
    ...
    if(nResultDataAddr)
    {
        ...
        if(pcm_nAppCmdResultDataLen > (FMSTR_SIZE8) 32)
        {
            pcm_nAppCmdResultDataLen = (FMSTR_SIZE8) 32;
        }
...
# 309 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
FMSTR_APPCMD_CODE FMSTR_GetAppCmd(void)
{
...
# 333 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
FMSTR_APPCMD_PDATA FMSTR_GetAppCmdData(FMSTR_SIZE* pDataLen)
{
    ...
    return pcm_nAppCmdLen ? pcm_pAppCmdBuff : (FMSTR_APPCMD_PDATA) ((void *) 0);
}
# 370 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
FMSTR_BOOL FMSTR_RegisterAppCmdCall(FMSTR_APPCMD_CODE nAppCmdCode, FMSTR_PAPPCMDFUNC pCallbackFunc)
{
    ...
    if((nIndex < 0) && (pCallbackFunc != ((void *) 0)))
    {
        nIndex = FMSTR_FindAppCmdCallIndex(0xffU);
    }
    ...
    return (1U);
# 412 "../FreeMaster_S32xx/src_common/freemaster_appcmd.c"
}
