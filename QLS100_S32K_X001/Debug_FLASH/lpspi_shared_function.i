# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_shared_function.c"
...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_shared_function.c"
# 73 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_shared_function.c"
...
# 74 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_shared_function.c" 2
...
# 75 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_shared_function.c" 2
...
LPSPI_Type * g_lpspiBase[(1u)] = { ((LPSPI_Type *)(0x4002C000u)) };


IRQn_Type g_lpspiIrqId[(1u)] = { LPSPI0_IRQn };


lpspi_state_t * g_lpspiStatePtr[(1u)] = {0L};
# 103 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_shared_function.c"
void LPSPI_DRV_IRQHandler(uint32_t instance)
{
    if(instance < (1u))
    {
...
void LPSPI_DRV_FillupTxBuffer(uint32_t instance)
{
    ...
    while(availableSpace != 0U)
    {
        ...
        if (lpspiState->txBuff != 0L)
        {



            if ((lpspiState->lsb == 0) && (lpspiState->bytesPerFrame > 4U))
            {
                index = (uint16_t)(lpspiState->bytesPerFrame - 1U - lpspiState->txFrameCnt);
                if(index >= 3U)
                {
                    wordToSend = *(const uint32_t *)(lpspiState->txBuff + index - 3U);
                }
                else
                {
