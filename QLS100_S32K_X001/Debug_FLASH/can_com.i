# 1 "D:/s32dsworkspace/QLS/common/Comm_Mgt/Can_Com/can_com.c"
...
# 2 "D:/s32dsworkspace/QLS/common/Comm_Mgt/Can_Com/can_com.c" 2
...
# 21 "D:/s32dsworkspace/QLS/common/Comm_Mgt/Can_Com/can_com.c"
...
{
# 92 "D:/s32dsworkspace/QLS/common/Comm_Mgt/Can_Com/can_com.c"
...
{
# 109 "D:/s32dsworkspace/QLS/common/Comm_Mgt/Can_Com/can_com.c"
    comm_frameTx.set = (2);
    if (u8_cancomm_ABTRQ)
    {
        u8_cancomm_ABTRQ = 0;
...
uint8_t u8_cancomm_TxOneFrame(void)
{
    ...
    if (queueP->size > 0 && (1) != LframeP->set)
    {
        pos = queueP->tail;
        frameP = &(queueP->queue[pos]);
