# 1 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
...
# 1 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
# 16 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
...
# 17 "../FreeMaster_S32xx/src_common/freemaster_rec.c" 2
...
# 18 "../FreeMaster_S32xx/src_common/freemaster_rec.c" 2
...
# 19 "../FreeMaster_S32xx/src_common/freemaster_rec.c" 2



# 1 "../FreeMaster_S32xx/src_common/freemaster_rec.h" 1
# 17 "../FreeMaster_S32xx/src_common/freemaster_rec.h"
#define __FREEMASTER_REC_H 
# 31 "../FreeMaster_S32xx/src_common/freemaster_rec.h"
...
# 55 "../FreeMaster_S32xx/src_common/freemaster_rec.h"
...
# 23 "../FreeMaster_S32xx/src_common/freemaster_rec.c" 2
# 33 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
...
static FMSTR_U8 pcm_pOwnRecBuffer[2048];
# 121 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
...
# 155 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
...
# 185 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
...
# 207 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
FMSTR_BPTR FMSTR_SetUpRec(FMSTR_BPTR pMessageIO)
{
    ...
    FMSTR_AbortRec();
# 226 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
    ( pcm_nRecBuffAddr = (FMSTR_ADDR) (FMSTR_U8*) pcm_pOwnRecBuffer );
...
# 329 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
    }
    ...
    {
# 358 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
        if(pcm_bTrgVarSigned&0x02)
        {
    ...
    blen = (FMSTR_SIZE_RECBUFF) (pcm_wRecTotalSmps * nRecVarsetSize / 1);
...
# 422 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
...
# 441 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
void FMSTR_TriggerRec(void)
{
...
# 468 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
FMSTR_BPTR FMSTR_StartRec(FMSTR_BPTR pMessageIO)
{
     FMSTR_U8 nResponseCode;
...
# 518 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
...
# 544 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
FMSTR_BPTR FMSTR_StopRec(FMSTR_BPTR pMessageIO)
{
    FMSTR_U8 nResponseCode;
...
# 582 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
FMSTR_BPTR FMSTR_GetRecStatus(FMSTR_BPTR pMessageIO)
{
...
# 608 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
FMSTR_SIZE_RECBUFF FMSTR_GetRecBuffSize()
{



    return (FMSTR_SIZE_RECBUFF) 2048;

}
# 631 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
...
# 657 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
FMSTR_BPTR FMSTR_GetRecBuff(FMSTR_BPTR pMessageIO)
{
    ...
    pResponse = ( (*((FMSTR_U8*)(pMessageIO)) = (FMSTR_U8)(0x00U)), (((FMSTR_BPTR)(pMessageIO))+1) );
    pResponse = FMSTR_AddressToBuffer(pResponse, pcm_nRecBuffAddr);
    return FMSTR_ValueToBuffer16(pResponse, pcm_wRecBuffStartIx);
}
# 690 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
...
# 747 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
void FMSTR_Recorder(void)
{
...
# 769 "../FreeMaster_S32xx/src_common/freemaster_rec.c"
static void FMSTR_Recorder2(void)
{
    FMSTR_SIZE8 sz;
    FMSTR_BOOL cmp;
