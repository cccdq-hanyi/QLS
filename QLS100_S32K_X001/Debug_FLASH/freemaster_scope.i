# 1 "../FreeMaster_S32xx/src_common/freemaster_scope.c"
...
# 1 "../FreeMaster_S32xx/src_common/freemaster_scope.c"
# 16 "../FreeMaster_S32xx/src_common/freemaster_scope.c"
...
# 17 "../FreeMaster_S32xx/src_common/freemaster_scope.c" 2
...
# 18 "../FreeMaster_S32xx/src_common/freemaster_scope.c" 2
...
# 19 "../FreeMaster_S32xx/src_common/freemaster_scope.c" 2
...
static FMSTR_U8 pcm_nScopeVarCount;
static FMSTR_ADDR pcm_pScopeVarAddr[8];
static FMSTR_SIZE8 pcm_pScopeVarSize[8];
...
# 51 "../FreeMaster_S32xx/src_common/freemaster_scope.c"
FMSTR_BPTR FMSTR_SetUpScope(FMSTR_BPTR pMessageIO)
{
    ...
    pMessageIO = ( (*((FMSTR_U8*)(&nVarCnt)) = *(FMSTR_U8*)(pMessageIO)), (((FMSTR_BPTR)(pMessageIO))+1) );


    if(!nVarCnt || nVarCnt > (FMSTR_U8)8)
    {
...
# 102 "../FreeMaster_S32xx/src_common/freemaster_scope.c"
    }
...
# 122 "../FreeMaster_S32xx/src_common/freemaster_scope.c"
FMSTR_BPTR FMSTR_ReadScope(FMSTR_BPTR pMessageIO)
{
    FMSTR_U8 i;
