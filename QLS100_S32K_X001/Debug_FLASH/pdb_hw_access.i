# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/pdb/pdb_hw_access.c"
...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/pdb/pdb_hw_access.c"
# 18 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/pdb/pdb_hw_access.c"
...
void PDB_DRV_SetCmpPulseOutDelayForLow(const uint32_t instance,
                                       const uint32_t pulseChn,
                                       const uint32_t value);
# 23 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/pdb/pdb_hw_access.h" 2
...
# 19 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/pdb/pdb_hw_access.c" 2
# 27 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/pdb/pdb_hw_access.c"
void PDB_Init(PDB_Type * const base)
{
    DevAssert(base != 0L);
    uint32_t chn, preChn;
    ...
    for (chn = 0U; chn < 2u; chn++)
    {
        base->CH[chn].C1 = 0U;
        base->CH[chn].S = 0U;
        for (preChn = 0U; preChn < 8u; preChn++)
        {
                     ...
                     const pdb_timer_config_t * configPtr)
{
    ...
    sc |= (((uint32_t)(((uint32_t)((uint32_t)(configPtr->loadValueMode)))<<18u))&0xC0000u);
    if (configPtr->seqErrIntEnable)
    {
        sc |= 0x20000u;
    }
    sc |= (((uint32_t)(((uint32_t)((uint32_t)(configPtr->clkPreDiv)))<<12u))&0x7000u);
    sc |= (((uint32_t)(((uint32_t)((uint32_t)(configPtr->triggerInput)))<<8u))&0xF00u);
    sc |= (((uint32_t)(((uint32_t)((uint32_t)(configPtr->clkPreMultFactor)))<<2u))&0xCu);
                                          ...
                                          int enable)
{
    ...
    if (enable)
    {
        c1 |= (((uint32_t)(((uint32_t)(preChnMask))<<16u))&0xFF0000u);
    }
    else
    {
        c1 &= ~(((uint32_t)(((uint32_t)(preChnMask))<<16u))&0xFF0000u);
                                      ...
                                      int enable)
{
    ...
    if (enable)
    {
        c1 |= (((uint32_t)(((uint32_t)(preChnMask))<<8u))&0xFF00u);
    }
    else
    {
        c1 &= ~(((uint32_t)(((uint32_t)(preChnMask))<<8u))&0xFF00u);
                                ...
                                int enable)
{
    ...
    if (enable)
    {
        c1 |= (((uint32_t)(((uint32_t)(preChnMask))<<0u))&0xFFu);
    }
    else
    {
        c1 &= ~(((uint32_t)(((uint32_t)(preChnMask))<<0u))&0xFFu);
...
# 193 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/pdb/pdb_hw_access.c"
void PDB_ClearAdcPreTriggerFlags(PDB_Type * const base,
                                 uint32_t chn,
                                 uint32_t preChnMask)
{
    ...
    s &= ~(((uint32_t)(((uint32_t)(preChnMask))<<16u))&0xFF0000u);
                                       ...
                                       uint32_t preChnMask)
{
    ...
    uint32_t s = base->CH[chn].S;
    s &= ~(((uint32_t)(((uint32_t)(preChnMask))<<0u))&0xFFu);
                              ...
                              int enable)
{
    ...
    if (enable)
    {
        poen |= (((uint32_t)(((uint32_t)(pulseChnMask))<<0u))&0xFFu);
    }
    else
    {
        poen &= ~(((uint32_t)(((uint32_t)(pulseChnMask))<<0u))&0xFFu);
