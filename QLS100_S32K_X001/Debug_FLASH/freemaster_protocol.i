# 1 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
...
# 1 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
# 16 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
...
# 17 "../FreeMaster_S32xx/src_common/freemaster_protocol.c" 2
...
# 18 "../FreeMaster_S32xx/src_common/freemaster_protocol.c" 2
...
# 19 "../FreeMaster_S32xx/src_common/freemaster_protocol.c" 2
# 38 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_BOOL FMSTR_Init(void)
{
    ...
    FMSTR_InitAppCmds();
# 72 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
    if(!FMSTR_InitCan())
        return (0U);
# 98 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
    return (1U);
}
# 115 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_BOOL FMSTR_ProtocolDecoder(FMSTR_BPTR pMessageIO)
{
    ...
    (void)( (*((FMSTR_U8*)(&nCmd)) = *(FMSTR_U8*)(pMessageIO)), (((FMSTR_BPTR)(pMessageIO))+1) );
    ...
    switch (nCmd)
    {
        ...
        case 0x06U:
            ...
            break;
# 357 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
        case 0xc0U:

            pResponseEnd = FMSTR_GetBoardInfo(pMessageIO);
            break;
# 380 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
        default:
...
# 414 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_BOOL FMSTR_SendTestFrame(FMSTR_BPTR pMessageIO)
{
    FMSTR_BPTR pResponse = pMessageIO;
    pResponse = ( (*((FMSTR_U8*)(pResponse)) = (FMSTR_U8)(0xA9U)), (((FMSTR_BPTR)(pResponse))+1) );
    FMSTR_SendResponse(pMessageIO, 1);
    return (1U);
}
# 433 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_GetBoardInfo(FMSTR_BPTR pMessageIO)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_U16 wTmp;
    ...
    pResponse = ( (*((FMSTR_U8*)(pResponse)) = (FMSTR_U8)((FMSTR_U8)(0))), (((FMSTR_BPTR)(pResponse))+1) );
    pResponse = ( (*((FMSTR_U8*)(pResponse)) = (FMSTR_U8)((FMSTR_U8)((((8)*5)+18+2)))), (((FMSTR_BPTR)(pResponse))+1) );
# 460 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
    ...
    pResponse = FMSTR_ValueToBuffer16(pResponse, (FMSTR_U16) (((0) & 0x3fffU) | 0x4000U));
# 481 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
    pStr = (FMSTR_U8*) "S32xx FreeMASTER";
...
# 510 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_ReadMem(FMSTR_BPTR pMessageIO)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
...
# 528 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
    if(nSize > (FMSTR_U8)(((8)*5)+18+2))
    {
...
# 550 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_ReadVar(FMSTR_BPTR pMessageIO, FMSTR_SIZE8 nSize)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
    ...
    pMessageIO = FMSTR_AddressFromBuffer(&nAddr, pMessageIO);
# 566 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
    pResponse = ( (*((FMSTR_U8*)(pResponse)) = (FMSTR_U8)(0x00U)), (((FMSTR_BPTR)(pResponse))+1) );

    return FMSTR_CopyToBuffer(pResponse, nAddr, nSize);
}
# 582 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_WriteMem(FMSTR_BPTR pMessageIO)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
    ...
    pMessageIO = ( (*((FMSTR_U8*)(&nSize)) = *(FMSTR_U8*)(pMessageIO)), (((FMSTR_BPTR)(pMessageIO))+1) );
    pMessageIO = FMSTR_AddressFromBuffer(&nAddr, pMessageIO);
# 601 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
...
# 623 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_WriteVar(FMSTR_BPTR pMessageIO, FMSTR_SIZE8 nSize)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
    ...
    pMessageIO = ( ((FMSTR_BPTR)(pMessageIO)) + (1U) );
    pMessageIO = FMSTR_AddressFromBuffer(&nAddr, pMessageIO);
# 641 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
...
# 663 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_WriteMemMask(FMSTR_BPTR pMessageIO)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
    ...
    pMessageIO = ( (*((FMSTR_U8*)(&nSize)) = *(FMSTR_U8*)(pMessageIO)), (((FMSTR_BPTR)(pMessageIO))+1) );
    pMessageIO = FMSTR_AddressFromBuffer(&nAddr, pMessageIO);
# 691 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
...
# 713 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_WriteVarMask(FMSTR_BPTR pMessageIO, FMSTR_SIZE8 nSize)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
    ...
    pMessageIO = ( ((FMSTR_BPTR)(pMessageIO)) + (1U) );
    pMessageIO = FMSTR_AddressFromBuffer(&nAddr, pMessageIO);
# 731 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
...
# 748 "../FreeMaster_S32xx/src_common/freemaster_protocol.c"
FMSTR_U16 FMSTR_StrLen(FMSTR_ADDR nAddr)
{
    const char* pStr;
    FMSTR_U16 nLen = 0U;
