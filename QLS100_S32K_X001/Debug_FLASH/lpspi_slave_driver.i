# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_slave_driver.c"
...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_slave_driver.c"
# 82 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_slave_driver.c"
...
# 83 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
...
# 32 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/inc/lpspi_slave_driver.h" 2
...
# 84 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/inc/clock_manager.h" 1
# 85 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
...
# 86 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
...
# 87 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
# 95 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_slave_driver.c"
                                   ...
                                   uint16_t transferByteCount)
{
    DevAssert(instance < (1u));
    DevAssert(g_lpspiStatePtr[instance] != 0L);
    DevAssert(!((sendBuffer == 0L) && (receiveBuffer == 0L)));
    LPSPI_Type * base = g_lpspiBase[instance];
    lpspi_state_t * state = (lpspi_state_t *)g_lpspiStatePtr[instance];
    ...
    if (state->isTransferInProgress == 1)
    {
        return STATUS_BUSY;
    }
    ...
    else
    {
        ...
        if(receiveBuffer != 0L)
        {
            (void)EDMA_DRV_ConfigMultiBlockTransfer(state->rxDMAChannel, EDMA_TRANSFER_PERIPH2MEM,
...
void LPSPI_DRV_SlaveIRQHandler(uint32_t instance)
{
    ...
    if (LPSPI_GetStatusFlag(base,LPSPI_TX_DATA_FLAG) && ((txCount != (uint8_t)0)))
    {
    ...
    if ((rxCount == (uint8_t)0) && (txCount == (uint8_t)0))
    {
        ...
        LPSPI_SetIntMode(base,LPSPI_TRANSMIT_ERROR , 0);
        LPSPI_SetIntMode(base,LPSPI_RECEIVE_ERROR , 0);
...
status_t LPSPI_DRV_SlaveAbortTransfer(uint32_t instance)
{
    ...
    state->isTransferInProgress = 0;

    LPSPI_SetFlushFifoCmd(base, 1, 1);

    LPSPI_SetFlushFifoCmd(base, 1, 1);
    if(state->isBlocking == 1)
    {
