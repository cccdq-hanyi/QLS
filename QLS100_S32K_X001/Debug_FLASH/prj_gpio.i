# 1 "D:/s32dsworkspace/QLS/common/HW_Driver/prj_gpio.c"
...
# 10 "D:/s32dsworkspace/QLS/common/HW_Driver/prj_gpio.h" 2
...
# 2 "D:/s32dsworkspace/QLS/common/HW_Driver/prj_gpio.c" 2
...
# 28 "D:/s32dsworkspace/QLS/common/HW_Driver/prj_gpio.c"
void v_GPIO_Init(func_v_v _func)
{
 ...
 ((GPIO_Type *)(0x400FF0C0u))->PIDR &= ~(1 << 3);
 ((GPIO_Type *)(0x400FF0C0u))->PDDR &= ~(1 << 3);

 ((PORT_Type *)(0x4004C000u))->ISFR = 0xFFFFFFFF;
 ((PORT_Type *)(0x4004C000u))->PCR[3] = 0x00090102;
 ...
 ((S32_NVIC_Type *)(0xE000E100u))->ICPR[0] = 1 << (PORT_IRQn % 32);
 ((S32_NVIC_Type *)(0xE000E100u))->ISER[0] = 1 << (PORT_IRQn % 32);
 ((S32_NVIC_Type *)(0xE000E100u))->IPR[PORT_IRQn % 4] = 0x1;
...
void PORT_IRQHandler(void)
{
 ...
 u32_flag = ((PORT_Type *)(0x40049000u))->ISFR;
 ((PORT_Type *)(0x40049000u))->ISFR = u32_flag;

 u32_flag = ((PORT_Type *)(0x4004C000u))->ISFR;

 ((PORT_Type *)(0x4004C000u))->ISFR = u32_flag;
...
uint8_t u8_GPIO_Read(uint8_t u8_type)
{
 ...
 {
 case (0):
  if (((GPIO_Type *)(0x400FF0C0u))->PDIR & (1 << 3))
  {
   u8_result = 1;
  }
  break;
 case (1):
  if (((GPIO_Type *)(0x400FF000u))->PDIR & (1 << 7))
  {
   u8_result = 1;
  }
  break;
...
void v_GPIO_Tranceiver_Enable(void)
{
 ...
 ((GPIO_Type *)(0x400FF040u))->PDDR |= (1 << 0);
 ((PORT_Type *)(0x4004A000u))->PCR[0] = 0x00000100;
 ((GPIO_Type *)(0x400FF040u))->PDOR |= (1 << 0);
}
