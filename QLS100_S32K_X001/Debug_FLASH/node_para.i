# 1 "../Sources/Node_Mgt/node_para.c"
...
# 9 "../Sources/Node_Mgt/node_para.h" 2
...
# 2 "../Sources/Node_Mgt/node_para.c" 2

node_info_struct node_info;

const u8_Frame_Struct FrameTx[(2)] = {
 {(0x18FD9BA3), (1000), (8), ((1))},
 {(0x18FE56A3), (1000), (8), ((1))},
};
...
static uint8_t u8_node_CANDB_Init(void)
{
 ...
 node_info.Frame_Tx_1_Temp.subs_type = (2);
 node_info.Frame_Tx_1_Temp.min = 0;
 node_info.Frame_Tx_1_Temp.max = 255;

 node_info.Frame_Tx_1_Conc.def = 0;
 node_info.Frame_Tx_1_Conc.subs = 0;
 node_info.Frame_Tx_1_Conc.subs_type = (2);
 ...
 node_info.Frame_Tx_1_Temp_Pre.subs_type = (2);
 ...
 node_info.Frame_Tx_1_Proper_Pre.subs_type = (2);
 ...
 node_info.Frame_Tx_1_Property.subs_type = (2);
 ...
 node_info.Frame_Tx_2_Tank_Lev.subs_type = (2);
 ...
 node_info.Frame_Tx_2_Tank_Temp.subs_type = (2);
 ...
 node_info.Frame_Tx_2_Tank_Lev2.subs_type = (2);
 ...
 node_info.Frame_Tx_2_Tank_Lev_Pre.subs_type = (2);
 ...
 node_info.Frame_Tx_2_Tank_Temp_Pre.subs_type = (2);
...
static uint8_t u8_node_Comm_init(void)
{
 ...
 for (i = 0; i < (2); i++)
 {
  ...
  node_info.msg_tx_ecu[i].Status = (0);
 ...
 node_info.comm_status = ((0x01) | (0x10));
 node_info.u8_Dcomm_status = ((0x01) | (0x10));
 return 0;
}
