...
int8_t rs8_x_temp[10] = {-20,-10,-5,0,5,10,15,20,30,45};
float rf32_y_velocity[10] = {1500,1510,1520,1530,1540,1550,1560,1570,1580,1590};
uint8_t calibrat_flag;
uint8_t C2_CALCON_TABLE[10][10]={0,};

TABLE1_UNION C2_LEVEL_TABLE={0,{0,}};;
TABLE10_UNION C2_CON_TABLE={0,{0,}};
# 39 "D:/s32dsworkspace/QLS/common/ultrasonic.c"
...
# 77 "D:/s32dsworkspace/QLS/common/ultrasonic.c"
  ...
  while(bg < ed)
  {
   ...
   if (v > rf32_y_velocity[mid])
    ...
    ru8_concentration = C2_CALCON_TABLE[p_v][p_temp]+
      ( C2_CALCON_TABLE[p_v+1][p_temp+1] - C2_CALCON_TABLE[p_v][p_temp] ) * ( rf32_y_velocity[p_v+1] - rf32_y_velocity[p_v] ) / ( v - rf32_y_velocity[p_v] );
