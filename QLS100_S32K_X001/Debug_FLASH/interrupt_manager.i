# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
# 58 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
...
# 22 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/inc/interrupt_manager.h" 2
...
# 59 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c" 2
# 67 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
...
extern uint32_t __VECTOR_RAM[((uint32_t)((LPUART0_RxTx_IRQn))) + 16U + 1U];
# 98 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_InstallHandler(IRQn_Type irqNumber,
                            const isr_t newHandler,
                            isr_t* const oldHandler)
{
    ...
    DevAssert(dev_irqNumber <= (int32_t)(LPUART0_RxTx_IRQn));
...
# 143 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
   __VECTOR_RAM[((int32_t)irqNumber) + 16] = (uint32_t)newHandler;


}
# 158 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_EnableIRQ(IRQn_Type irqNumber)
{


    DevAssert(0 <= (int32_t)irqNumber);
    DevAssert((uint32_t)irqNumber <= (uint32_t)(LPUART0_RxTx_IRQn));


    ((S32_NVIC_Type *)(0xE000E100u))->ISER[(uint32_t)(irqNumber) >> 5U] = (uint32_t)(1UL << ((uint32_t)(irqNumber) & (uint32_t)0x1FU));
# 175 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
}
# 186 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_DisableIRQ(IRQn_Type irqNumber)
{
...
# 204 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
}
# 214 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_EnableIRQGlobal(void)
{
...
# 237 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_DisableIRQGlobal(void)
{
...
# 255 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_SetPriority(IRQn_Type irqNumber, uint8_t priority)
{
    ...
    int32_t dev_irqNumber = (int32_t)irqNumber;
    DevAssert(dev_irqNumber <= (int32_t)(LPUART0_RxTx_IRQn));
    DevAssert(priority < (uint8_t)(1U << (2U)));



    uint8_t shift = (uint8_t) (8U - (2U));
    ...
    if ((int32_t)irqNumber < 0)
    {
        ...
        DevAssert((int32_t)regId != 1);

        volatile uint32_t * shpr_reg_ptr = ((regId == 2U) ? (volatile uint32_t *)&((S32_SCB_Type *)(0xE000E000u))->SHPR2 : (volatile uint32_t *)&((S32_SCB_Type *)(0xE000E000u))->SHPR3);
    ...
    else
    {
        ...
        ((S32_NVIC_Type *)(0xE000E100u))->IPR[iprVectorId] &= ~(0xFFUL << priByteShift);

        ((S32_NVIC_Type *)(0xE000E100u))->IPR[iprVectorId] |= ((uint32_t)(((((uint32_t)priority) << shift)) & 0xFFUL)) << priByteShift;



    }
}
# 319 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
uint8_t INT_SYS_GetPriority(IRQn_Type irqNumber)
{
    ...
    if ((int32_t)irqNumber < 0)
    {
        ...
        volatile const uint32_t * shpr_reg_ptr = ((regId == 2U) ? (volatile uint32_t *)&((S32_SCB_Type *)(0xE000E000u))->SHPR2 : (volatile uint32_t *)&((S32_SCB_Type *)(0xE000E000u))->SHPR3);
        uint8_t priByteShift = ((uint8_t)(intVectorId) & 0x3U) << 3U;
    ...
    else
    {
        ...
        uint32_t iprVectorId = (uint32_t)(irqNumber) >> 2U;
        uint8_t priByteShift = (((uint8_t)(irqNumber)) & 0x3U) << 3U;
        priority = ((uint8_t)(((S32_NVIC_Type *)(0xE000E100u))->IPR[iprVectorId] >> priByteShift)) >> shift;
...
# 378 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_ClearPending(IRQn_Type irqNumber)
{
    ...
    DevAssert(0 <= (int32_t)irqNumber);
    DevAssert((uint32_t)irqNumber <= (uint32_t)(LPUART0_RxTx_IRQn));
# 405 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
    ((S32_NVIC_Type *)(0xE000E100u))->ICPR[(uint32_t)(irqNumber) >> 5U] = (uint32_t)(1UL << ((uint32_t)(irqNumber) & (uint32_t)0x1FU));
}
# 416 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_SetPending(IRQn_Type irqNumber)
{
...
# 436 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
uint32_t INT_SYS_GetPending(IRQn_Type irqNumber)
{
    ...
    DevAssert(0 <= (int32_t)irqNumber);
    DevAssert((uint32_t)irqNumber <= (uint32_t)(LPUART0_RxTx_IRQn));
# 455 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/interrupt/interrupt_manager.c"
