# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.c"
...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.c"
# 46 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.c"
...
# 47 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.c" 2
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.h" 1
# 29 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.h"
#define SYSTEM_S32K116_H_ 
# 43 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.h"
...
# 70 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.h"
extern uint32_t SystemCoreClock;
# 79 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.h"
void SystemInit(void);
# 92 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.h"
...
# 48 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.c" 2
...
# 65 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.c"
void SystemInit(void)
{
    ...
    ((WDOG_Type *)(0x40052000u))->CNT = (uint32_t ) (0xD928C520U);


    (void)((WDOG_Type *)(0x40052000u))->CNT;




    ((WDOG_Type *)(0x40052000u))->CS = (uint32_t ) ( (1UL << 13u) |
                              ((0x1UL) << 8u) |
                              (0U << 7u) |
                              (1U << 5u) );


    ((WDOG_Type *)(0x40052000u))->TOVAL = (uint32_t )0xFFFF;

}
# 100 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.c"
void SystemCoreClockUpdate(void)
{
    uint32_t SCGOUTClock = 0U;
    uint32_t regValue;
    uint32_t divider;
    int validSystemClockSource = 1;

    divider = ((((SCG_Type *)(0x40064000u))->CSR & 0xF0000u) >> 16u) + 1U;

    switch ((((SCG_Type *)(0x40064000u))->CSR & 0xF000000u) >> 24u)
    {
        case 0x1:

            SCGOUTClock = 8000000u;
            break;
        case 0x2:

            regValue = (((SCG_Type *)(0x40064000u))->SIRCCFG & 0x1u) >> 0u;
            if (regValue != 0UL)
            {
                SCGOUTClock = (8000000U);
            }
            ...
            {
                validSystemClockSource = 0;
            }
            break;
        case 0x3:

            regValue = (((SCG_Type *)(0x40064000u))->FIRCCFG & 0x3u) >> 0u;
            if (regValue == 0x0UL)
            {
                SCGOUTClock = (48000000U);
            }
            else
            {
                validSystemClockSource = 0;
    ...
    if (validSystemClockSource == 1)
    {
        SystemCoreClock = (SCGOUTClock / divider);
    }
}
# 157 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/devices/S32K116/startup/system_S32K116.c"
void SystemSoftwareReset(void)
{
    uint32_t regValue;


    regValue = ((S32_SCB_Type *)(0xE000E000u))->AIRCR;


    regValue &= ~( 0xFFFF0000u);


    regValue |= (((uint32_t)(((uint32_t)((0x05FAU)))<<16u))&0xFFFF0000u);
    regValue |= (((uint32_t)(((uint32_t)(0x1u))<<2u))&0x4u);


    ((S32_SCB_Type *)(0xE000E000u))->AIRCR = regValue;
}
