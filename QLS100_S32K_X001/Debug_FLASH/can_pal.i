...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
# 67 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
...
# 68 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c" 2
...
#define false 0
# 69 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c" 2
...
status_t CAN_InstallEventCallback(can_instance_t instance,
                                  ...
                                  void *callbackParam);
# 71 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c" 2
# 79 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
typedef struct
{
    int rxFifoEn;
    flexcan_rx_fifo_id_filter_num_t numIdFilters;
} flexcan_rx_fifo_state_t;
# 93 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
static flexcan_state_t s_flexcanState[1U];

static can_instance_t s_flexcanStateInstanceMapping[1U];

static int s_flexcanStateIsAllocated[1U];

static const can_buff_config_t *s_hwObjConfigs[1U][(32U)];

static flexcan_rx_fifo_state_t s_flexcanRxFifoState[1U];

static can_callback_t userCallbacks[1U];
# 117 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
static uint8_t CAN_AllocateState(int *isAllocated,
...
static void CAN_FreeState(int *isAllocated,
...
# 168 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
static inline uint32_t CAN_GetVirtualBuffIdx(uint32_t x)
{
    return (5U + ((((x) + 1U) * 8U) / 4U));
}
# 180 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
static void CAN_InternalCallback(uint8_t instance,
                             flexcan_event_type_t eventType,
                             uint32_t buffIdx,
                             flexcan_state_t *state)
{
    can_callback_t callback = userCallbacks[instance];


    if ((s_flexcanRxFifoState[instance].rxFifoEn == 1) && (buffIdx != 0U))
    {
...
# 233 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_Init(can_instance_t instance, const can_user_config_t *config)
{
    ...
    if ((uint8_t)instance <= 0U)
    {
        flexcan_user_config_t flexcanConfig;


        s_flexcanRxFifoState[instance].rxFifoEn = 0;
        ...
        if (config->extension != 0L)
        {
            flexcanConfig.is_rx_fifo_needed = 1;
            ...
            s_flexcanRxFifoState[instance].rxFifoEn = 1;
            s_flexcanRxFifoState[instance].numIdFilters = flexcanConfig.num_id_filters;
        }
        else
        {
            flexcanConfig.is_rx_fifo_needed = 0;
        ...
        if ((status == STATUS_SUCCESS) && (s_flexcanRxFifoState[instance].rxFifoEn == 1))
        {
...
# 331 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_Deinit(can_instance_t instance)
{
    status_t status = STATUS_ERROR;
...
# 362 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_SetBitrate(can_instance_t instance,
                        can_bitrate_phase_t phase,
                        const can_time_segment_t *bitTiming)
{
...
# 397 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_GetBitrate(can_instance_t instance,
                        can_bitrate_phase_t phase,
                        can_time_segment_t *bitTiming)
{
...
# 432 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_ConfigTxBuff(can_instance_t instance,
                          uint32_t buffIdx,
                          const can_buff_config_t *config)
{
    ...
    if ((uint8_t)instance <= 0U)
    {
        ...
        DevAssert((s_flexcanRxFifoState[instance].rxFifoEn == 0) || (buffIdx != 0U));

        DevAssert(buffIdx < (32U));
...
# 482 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_ConfigRxBuff(can_instance_t instance,
                          uint32_t buffIdx,
                          const can_buff_config_t *config,
                          uint32_t acceptedId)
...
# 536 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_Send(can_instance_t instance,
                  uint32_t buffIdx,
                  const can_message_t *message)
{
...
# 587 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_SendBlocking(can_instance_t instance,
                          uint32_t buffIdx,
                          const can_message_t *message,
                          uint32_t timeoutMs)
...
# 639 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_Receive(can_instance_t instance,
                     uint32_t buffIdx,
                     can_message_t *message)
{
...
# 683 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_ReceiveBlocking(can_instance_t instance,
                             uint32_t buffIdx,
                             can_message_t *message,
                             uint32_t timeoutMs)
...
# 730 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_SetRxFilter(can_instance_t instance,
                         can_msg_id_type_t idType,
                         uint32_t buffIdx,
                         uint32_t mask)
...
# 764 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_GetTransferStatus(can_instance_t instance, uint32_t buffIdx)
{
    status_t status = STATUS_ERROR;
    ...
    if ((uint8_t)instance <= 0U)
    {
        ...
        if ((s_flexcanRxFifoState[instance].rxFifoEn) && (buffIdx != 0U))
        {
            buffIdx += CAN_GetVirtualBuffIdx(s_flexcanRxFifoState[instance].numIdFilters);
        }
...
# 795 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/pal/can/src/can_pal.c"
status_t CAN_InstallEventCallback(can_instance_t instance,
                                  can_callback_t callback,
                                  void *callbackParam)
{
    ...
    if ((uint8_t)instance <= 0U)
    {
        if (callback != 0L)
        {
            ...
            userCallbacks[instance] = callback;
        ...
        else
        {
            ...
            FLEXCAN_DRV_InstallEventCallback((uint8_t) instance, 0L, callbackParam);
        }
