...
.Ltext0:
	...
	.section	.bss.pcm_nScopeVarCount,"aw",%nobits
	.type	pcm_nScopeVarCount, %object
	.size	pcm_nScopeVarCount, 1
pcm_nScopeVarCount:
	.space	1
	.section	.bss.pcm_pScopeVarAddr,"aw",%nobits
	.align	2
	.type	pcm_pScopeVarAddr, %object
	.size	pcm_pScopeVarAddr, 32
pcm_pScopeVarAddr:
	.space	32
	.section	.bss.pcm_pScopeVarSize,"aw",%nobits
	.align	2
	.type	pcm_pScopeVarSize, %object
	.size	pcm_pScopeVarSize, 8
pcm_pScopeVarSize:
	.space	8
	.section	.text.FMSTR_InitScope,"ax",%progbits
	.align	2
	.global	FMSTR_InitScope
	.code	16
	.thumb_func
	.type	FMSTR_InitScope, %function
FMSTR_InitScope:
.LFB0:
	.file 1 "../FreeMaster_S32xx/src_common/freemaster_scope.c"
	.loc 1 37 0
	.cfi_startproc
	push	{r7, lr}
	...
	.cfi_endproc
.LFE0:
	.size	FMSTR_InitScope, .-FMSTR_InitScope
	.section	.text.FMSTR_SetUpScope,"ax",%progbits
	.align	2
	.global	FMSTR_SetUpScope
	.code	16
	.thumb_func
	.type	FMSTR_SetUpScope, %function
FMSTR_SetUpScope:
.LFB1:
	.loc 1 52 0
	.cfi_startproc
...
.L12:
	.align	2
.L11:
	.word	pcm_nScopeVarCount
	.word	pcm_pScopeVarSize
	.word	pcm_pScopeVarAddr
	.cfi_endproc
.LFE1:
	.size	FMSTR_SetUpScope, .-FMSTR_SetUpScope
	.section	.text.FMSTR_ReadScope,"ax",%progbits
	.align	2
	.global	FMSTR_ReadScope
	.code	16
	.thumb_func
	.type	FMSTR_ReadScope, %function
FMSTR_ReadScope:
.LFB2:
	.loc 1 123 0
	.cfi_startproc
...
.L18:
	...
	.cfi_endproc
.LFE2:
	.size	FMSTR_ReadScope, .-FMSTR_ReadScope
	.text
.Letext0:
...
.LASF775:
	.ascii	"../FreeMaster_S32xx/src_common/freemaster_scope.c\000"
.LASF105:
