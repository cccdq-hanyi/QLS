# 1 "../FreeMaster_S32xx/src_common/freemaster_can.c"
...
# 1 "../FreeMaster_S32xx/src_common/freemaster_can.c"
# 16 "../FreeMaster_S32xx/src_common/freemaster_can.c"
...
# 17 "../FreeMaster_S32xx/src_common/freemaster_can.c" 2
# 1 "../FreeMaster_S32xx/src_common/freemaster_private.h" 1
# 17 "../FreeMaster_S32xx/src_common/freemaster_private.h"
...
#define FMSTR_FCAN_ETXI() ( ((FMSTR_FLEXCAN_TXMB)&0x20) ? FMSTR_SETBIT32(FMSTR_CAN_BASE, FMSTR_FCANIER2_OFFSET, (1<<((FMSTR_FLEXCAN_TXMB)-32))): FMSTR_SETBIT32(FMSTR_CAN_BASE, FMSTR_FCANIER1_OFFSET, (1<<(FMSTR_FLEXCAN_TXMB))) )


#define FMSTR_FCAN_DTXI() ( ((FMSTR_FLEXCAN_TXMB)&0x20) ? FMSTR_CLRBIT32(FMSTR_CAN_BASE, FMSTR_FCANIER2_OFFSET, (1<<((FMSTR_FLEXCAN_TXMB)-32))): FMSTR_CLRBIT32(FMSTR_CAN_BASE, FMSTR_FCANIER1_OFFSET, (1<<(FMSTR_FLEXCAN_TXMB))) )


#define FMSTR_FCAN_ERXI() ( ((FMSTR_FLEXCAN_RXMB)&0x20) ? FMSTR_SETBIT32(FMSTR_CAN_BASE, FMSTR_FCANIER2_OFFSET, (1<<((FMSTR_FLEXCAN_RXMB)-32))): FMSTR_SETBIT32(FMSTR_CAN_BASE, FMSTR_FCANIER1_OFFSET, (1<<(FMSTR_FLEXCAN_RXMB))) )


#define FMSTR_FCAN_DRXI() ( ((FMSTR_FLEXCAN_RXMB)&0x20) ? FMSTR_CLRBIT32(FMSTR_CAN_BASE, FMSTR_FCANIER2_OFFSET, (1<<((FMSTR_FLEXCAN_RXMB)-32))): FMSTR_CLRBIT32(FMSTR_CAN_BASE, FMSTR_FCANIER1_OFFSET, (1<<(FMSTR_FLEXCAN_RXMB))) )




#define FMSTR_FCAN_TEST_RXFLG() ( ((FMSTR_FLEXCAN_RXMB)&0x20) ? FMSTR_TSTBIT32(FMSTR_CAN_BASE, FMSTR_FCANIFR2_OFFSET, (1<<((FMSTR_FLEXCAN_RXMB)-32))): FMSTR_TSTBIT32(FMSTR_CAN_BASE, FMSTR_FCANIFR1_OFFSET, (1<<(FMSTR_FLEXCAN_RXMB))) )


#define FMSTR_FCAN_CLEAR_RXFLG() ( ((FMSTR_FLEXCAN_RXMB)&0x20) ? FMSTR_SETREG32(FMSTR_CAN_BASE, FMSTR_FCANIFR2_OFFSET, (1<<((FMSTR_FLEXCAN_RXMB)-32))): FMSTR_SETREG32(FMSTR_CAN_BASE, FMSTR_FCANIFR1_OFFSET, (1<<(FMSTR_FLEXCAN_RXMB))) )




#define FMSTR_FCAN_TEST_TXFLG() ( ((FMSTR_FLEXCAN_TXMB)&0x20) ? FMSTR_TSTBIT32(FMSTR_CAN_BASE, FMSTR_FCANIFR2_OFFSET, (1<<((FMSTR_FLEXCAN_TXMB)-32))): FMSTR_TSTBIT32(FMSTR_CAN_BASE, FMSTR_FCANIFR1_OFFSET, (1<<(FMSTR_FLEXCAN_TXMB))) )
...
#define FMSTR_FCAN_RCFG() FMSTR_SETREG8(FMSTR_CAN_BASE, FMSTR_FCANRXFG_OFFSET + FMSTR_FCMBCSR + 3, FMSTR_FCANMB_CRXEMPTY)
...
#define FMSTR_FCAN_TLEN(pctx,len) FMSTR_SETREG8(FMSTR_CAN_BASE, FMSTR_FCANTXFG_OFFSET+FMSTR_FCMBCSR+2, (FMSTR_U8)((len & 0x0f) | (FMSTR_GETREG8(FMSTR_CAN_BASE, FMSTR_FCANTXFG_OFFSET+FMSTR_FCMBCSR+2)&(FMSTR_FCANCTRL_IDE | FMSTR_FCANCTRL_EXT_SRR | FMSTR_FCANCTRL_EXT_RTR))))




#define FMSTR_FCAN_PUTBYTE(pctx,dataByte) FMSTR_MACROCODE_BEGIN() FMSTR_SETREG8(FMSTR_CAN_BASE, (FMSTR_FCANTXFG_OFFSET + FMSTR_FCMBDSR0) - (0x3&((pctx)->nDataIx)) + (0x4&((pctx)->nDataIx)), (dataByte) ); (pctx)->nDataIx++; FMSTR_MACROCODE_END()
...
#define FMSTR_FCAN_TCFG(pctx) FMSTR_MACROCODE_BEGIN() (pctx)->nDataIx = 0; FMSTR_MACROCODE_END()





#define FMSTR_FCAN_TID(pctx,idr0,idr1,idr2,idr3) FMSTR_MACROCODE_BEGIN() FMSTR_SETREG32(FMSTR_CAN_BASE, FMSTR_FCANTXFG_OFFSET+FMSTR_FCMBIDR0, ((idr0)<<24) | ((idr1)<<16) | ((idr2)<<8) | (idr3) ); FMSTR_MACROCODE_END()
...
#define FMSTR_FCAN_TX(pctx) FMSTR_SETREG8(FMSTR_CAN_BASE, FMSTR_FCANTXFG_OFFSET + FMSTR_FCMBCSR + 3, (FMSTR_FCANMB_CTXTRANS_ONCE & 0x0f) )
...
#define FMSTR_FCAN_TEST_RIDR(pctx,idr0,idr1,idr2,idr3) ( (idr0 & FMSTR_FCANID0_EXT_FLG) ? ( ((((idr0)<<24) | ((idr1)<<16) | ((idr2)<<8) | (idr3))&0x1f000000)==((FMSTR_GETREG32(FMSTR_CAN_BASE, FMSTR_FCANRXFG_OFFSET+FMSTR_FCMBIDR0))&0x1f000000) ) : ( (((idr0)<<8) | (idr1))==((FMSTR_GETREG16(FMSTR_CAN_BASE, FMSTR_FCANRXFG_OFFSET+FMSTR_FCMBIDR0+2))&0x1ffc) ) )
...
#define FMSTR_FCAN_RLEN(pctx) (FMSTR_GETREG8(FMSTR_CAN_BASE, FMSTR_FCANRXFG_OFFSET+FMSTR_FCMBCSR+2) & 0x0f)



#define FMSTR_FCAN_GETBYTE(pctx) ((FMSTR_U8) (FMSTR_GETREG8(FMSTR_CAN_BASE, (FMSTR_FCANRXFG_OFFSET + FMSTR_FCMBDSR0) - (0x3&((pctx)->nDataIx)) + (0x4&((pctx)->nDataIx)) ))); (pctx)->nDataIx++




#define FMSTR_FCAN_RFINISH(pctx) FMSTR_SETBIT16(FMSTR_CAN_BASE, FMSTR_FCANTMR_OFFSET, 0)
# 142 "../FreeMaster_S32xx/src_common/freemaster_private.h" 2
#define FMSTR_PLATFORM S32xx
# 175 "../FreeMaster_S32xx/src_common/freemaster_private.h"
#define FMSTR_TRUE (1U)



#define FMSTR_FALSE (0U)
# 190 "../FreeMaster_S32xx/src_common/freemaster_private.h"
...
# 291 "../FreeMaster_S32xx/src_common/freemaster_private.h"
#define FMSTR_COUNT_INTERFACES ( ((FMSTR_DISABLE)?1:0) + ((FMSTR_USE_SCI)?1:0) + ((FMSTR_USE_ESCI)?1:0) + ((FMSTR_USE_LPUART)?1:0) + ((FMSTR_USE_PDBDM)?1:0) + ((FMSTR_USE_JTAG)?1:0) + ((FMSTR_USE_CAN)?1:0) + ((FMSTR_USE_LINTL)?1:0) + ((FMSTR_USE_MQX_IO)?1:0) + ((FMSTR_USE_USB_CDC)?1:0) + ((FMSTR_USE_MBED)?1:0) )
# 399 "../FreeMaster_S32xx/src_common/freemaster_private.h"
#define FMSTR_USE_SERIAL 0
# 18 "../FreeMaster_S32xx/src_common/freemaster_can.c" 2
# 1 "../FreeMaster_S32xx/src_common/freemaster_protocol.h" 1
# 17 "../FreeMaster_S32xx/src_common/freemaster_protocol.h"
...
# 19 "../FreeMaster_S32xx/src_common/freemaster_can.c" 2
# 61 "../FreeMaster_S32xx/src_common/freemaster_can.c"
...
# 139 "../FreeMaster_S32xx/src_common/freemaster_can.c"
static FMSTR_BCHR pcm_pCommBuffer[(((8)*5)+18+2)+3];
...
static volatile union
{
    ...
    struct
    {
        ...
        unsigned bTxFirst : 1;
        unsigned bRxActive : 1;
        unsigned bRxFirst : 1;
        unsigned bRxTgl1 : 1;
        unsigned bRxFrameReady : 1;
        unsigned bRxSpecial : 1;
...
static FMSTR_SIZE8 pcm_nRxCtr;
static FMSTR_BPTR pcm_pRxBuff;
static FMSTR_BCHR pcm_nRxErr;
static FMSTR_BCHR pcm_nRxCheckSum;
static FMSTR_U8 pcm_uTxCtlByte;
static FMSTR_U8 pcm_uTxFrmCtr;
# 185 "../FreeMaster_S32xx/src_common/freemaster_can.c"
...
# 205 "../FreeMaster_S32xx/src_common/freemaster_can.c"
...
# 224 "../FreeMaster_S32xx/src_common/freemaster_can.c"
...
FMSTR_BOOL FMSTR_InitCan(void)
{
    ...
    do{ (((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((((0x7aa)>>24)&0x1f) | 0x80) : (((0x7aa)>>6)&0x1f) )))&0x80) ? ((*(volatile FMSTR_U16*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((1) * 0x10)) + 0x00 + 2)) = (0x00<<8 | 0x20 | 0x40))) : ((*(volatile FMSTR_U16*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((1) * 0x10)) + 0x00 + 2)) = (0x00<<8 | 0x40)))); (*(volatile FMSTR_U32*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((1) * 0x10)) + 0x04)) = ((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((((0x7aa)>>24)&0x1f) | 0x80) : (((0x7aa)>>6)&0x1f) )))<<24) | ((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((0x7aa)>>16) : ((0x7aa)<<2) )))<<16) | ((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((0x7aa)>>8) : 0 )))<<8) | (((FMSTR_U8)( ((0x7aa)&0x80000000U) ? (0x7aa) : 0 )))); }while(0)
                                                               ;


    do{ (((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((((0x7aa)>>24)&0x1f) | 0x80) : (((0x7aa)>>6)&0x1f) )))&0x80) ? ((*(volatile FMSTR_U16*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((0) * 0x10)) + 0x00 + 2)) = (0x08<<8 | 0x20))) : ((*(volatile FMSTR_U16*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((0) * 0x10)) + 0x00 + 2)) = (0x08<<8 )))); }while(0)
                                                               ;
# 260 "../FreeMaster_S32xx/src_common/freemaster_can.c"
    FMSTR_Listen();

    return (1U);
}
# 285 "../FreeMaster_S32xx/src_common/freemaster_can.c"
void FMSTR_SetCanCmdID(FMSTR_U32 canID)
{
...
static void FMSTR_Listen(void)
{
    ...
    (*(volatile FMSTR_U8*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((1) * 0x10)) + 0x00 + 3)) = 0x04);
# 344 "../FreeMaster_S32xx/src_common/freemaster_can.c"
}
# 354 "../FreeMaster_S32xx/src_common/freemaster_can.c"
static void FMSTR_SendError(FMSTR_BCHR nErrCode)
{
...
# 373 "../FreeMaster_S32xx/src_common/freemaster_can.c"
...
# 409 "../FreeMaster_S32xx/src_common/freemaster_can.c"
}
# 423 "../FreeMaster_S32xx/src_common/freemaster_can.c"
FMSTR_BOOL FMSTR_TxCan(void)
{
    FMSTR_U8 ch;
    FMSTR_FCAN_TCTX tctx;
    ...
    if(pcm_wFlags.flg.bTxFirst)
    {
        ...
        pcm_uTxCtlByte = (FMSTR_U8) (0x20 | len);
        pcm_uTxFrmCtr = 0U;
    ...
    do{ (&tctx)->nDataIx = 0; }while(0);


    ;
    do{ (*(volatile FMSTR_U32*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((0) * 0x10))+0x04)) = ((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((((0x7aa)>>24)&0x1f) | 0x80) : (((0x7aa)>>6)&0x1f) )))<<24) | ((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((0x7aa)>>16) : ((0x7aa)<<2) )))<<16) | ((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((0x7aa)>>8) : 0 )))<<8) | (((FMSTR_U8)( ((0x7aa)&0x80000000U) ? (0x7aa) : 0 )))); }while(0)
                                                                            ;
    ...
    (*(volatile FMSTR_U8*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((0) * 0x10))+0x00 +2)) = (FMSTR_U8)(((FMSTR_U8) (len+1) & 0x0f) | ((*(volatile FMSTR_U8*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((0) * 0x10))+0x00 +2)))&(0x20 | 0x40 | 0x10))));


    do{ (*(volatile FMSTR_U8*)(((FMSTR_U32)(0x40024000UL))+(((0x80 + ((0) * 0x10)) + 0x0B) - (0x3&((&tctx)->nDataIx)) + (0x4&((&tctx)->nDataIx)))) = (pcm_uTxCtlByte)); (&tctx)->nDataIx++; }while(0);


    while(len--)
    {
        pcm_pTxBuff = ( (*((FMSTR_U8*)(&ch)) = *(FMSTR_U8*)(pcm_pTxBuff)), (((FMSTR_BPTR)(pcm_pTxBuff))+1) );
        do{ (*(volatile FMSTR_U8*)(((FMSTR_U32)(0x40024000UL))+(((0x80 + ((0) * 0x10)) + 0x0B) - (0x3&((&tctx)->nDataIx)) + (0x4&((&tctx)->nDataIx)))) = (ch)); (&tctx)->nDataIx++; }while(0);
    }


    (*(volatile FMSTR_U8*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((0) * 0x10)) + 0x00 + 3)) = (0x0C & 0x0f));
...
# 504 "../FreeMaster_S32xx/src_common/freemaster_can.c"
FMSTR_BOOL FMSTR_RxCan(void)
{
    FMSTR_FCAN_RCTX rctx;
    FMSTR_SIZE8 len;
    FMSTR_U8 ctl, ch;
    ...
    if(!( (((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((((0x7aa)>>24)&0x1f) | 0x80) : (((0x7aa)>>6)&0x1f) )) & 0x80) ? ( ((((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((((0x7aa)>>24)&0x1f) | 0x80) : (((0x7aa)>>6)&0x1f) )))<<24) | ((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((0x7aa)>>16) : ((0x7aa)<<2) )))<<16) | ((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((0x7aa)>>8) : 0 )))<<8) | (((FMSTR_U8)( ((0x7aa)&0x80000000U) ? (0x7aa) : 0 ))))&0x1f000000)==(((*(volatile FMSTR_U32*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((1) * 0x10))+0x04))))&0x1f000000) ) : ( (((((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((((0x7aa)>>24)&0x1f) | 0x80) : (((0x7aa)>>6)&0x1f) )))<<8) | (((FMSTR_U8)( ((0x7aa)&0x80000000U) ? ((0x7aa)>>16) : ((0x7aa)<<2) ))))==(((*(volatile FMSTR_U16*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((1) * 0x10))+0x04 +2))))&0x1ffc) ) )
                                                   )
    {
        (*(volatile FMSTR_U16*)(((FMSTR_U32)(0x40024000UL))+(0x08)) |= 0);
        return (0U);
    }


    ctl = ((FMSTR_U8) ((*(volatile FMSTR_U8*)(((FMSTR_U32)(0x40024000UL))+(((0x80 + ((1) * 0x10)) + 0x0B) - (0x3&((&rctx)->nDataIx)) + (0x4&((&rctx)->nDataIx))))))); (&rctx)->nDataIx++;
    ...
    if((ctl & 0x20) || pcm_wFlags.flg.bRxFirst)
    {
        if(!(ctl & 0x20) ||
            (ctl & 0x80))
        {
    ...
    else
    {
        ...
        if((pcm_wFlags.flg.bRxTgl1 && !(ctl & 0x80)) ||
           (!pcm_wFlags.flg.bRxTgl1 && (ctl & 0x80)))
        {
    ...
    len = (FMSTR_SIZE8) (ctl & 0x07);


    if(len >= ((*(volatile FMSTR_U8*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((1) * 0x10))+0x00 +2))) & 0x0f))
    {
    ...
    while(len--)
    {
        ch = ((FMSTR_U8) ((*(volatile FMSTR_U8*)(((FMSTR_U32)(0x40024000UL))+(((0x80 + ((1) * 0x10)) + 0x0B) - (0x3&((&rctx)->nDataIx)) + (0x4&((&rctx)->nDataIx))))))); (&rctx)->nDataIx++;
        pcm_pRxBuff = ( (*((FMSTR_U8*)(pcm_pRxBuff)) = (FMSTR_U8)(ch)), (((FMSTR_BPTR)(pcm_pRxBuff))+1) );
        pcm_nRxCheckSum += ch;
    }
...
static void FMSTR_RxDone(void)
{
    ...
    if(!pcm_nRxErr)
    {
        ...
        else
        {
            ...
            pFrame = ( (*((FMSTR_U8*)(&len)) = *(FMSTR_U8*)(pFrame)), (((FMSTR_BPTR)(pFrame))+1) );


            if((len & 0xc0U) == 0xc0U)
            {

                len = (FMSTR_BCHR)((len & 0x30U) >> 3);
    ...
    else
    {
        ...
        if(pcm_wFlags.flg.bRxSpecial)
        {
            ...
            (void)( (*((FMSTR_U8*)(&c)) = *(FMSTR_U8*)(pFrame)), (((FMSTR_BPTR)(pFrame))+1) );

            switch(c)
            {
            case 0xc0:
                FMSTR_SendError(0x00U);
                break;

            default:

                FMSTR_SendError(0x81U);
            }
        }
...
# 730 "../FreeMaster_S32xx/src_common/freemaster_can.c"
void FMSTR_ProcessCanRx(void)
{
    if(( ((1)&0x20) ? (*(volatile FMSTR_U32*)(((FMSTR_U32)(0x40024000UL))+(0x2C)) & ((1<<((1)-32)))): (*(volatile FMSTR_U32*)(((FMSTR_U32)(0x40024000UL))+(0x30)) & ((1<<(1)))) ))
    {

        FMSTR_RxCan();


        ( ((1)&0x20) ? (*(volatile FMSTR_U32*)(((FMSTR_U32)(0x40024000UL))+(0x2C)) = (1<<((1)-32))): (*(volatile FMSTR_U32*)(((FMSTR_U32)(0x40024000UL))+(0x30)) = (1<<(1))) );
...
# 758 "../FreeMaster_S32xx/src_common/freemaster_can.c"
}
# 768 "../FreeMaster_S32xx/src_common/freemaster_can.c"
void FMSTR_ProcessCanTx(void)
{
# 789 "../FreeMaster_S32xx/src_common/freemaster_can.c"
    if((((*(volatile FMSTR_U8*)(((FMSTR_U32)(0x40024000UL))+((0x80 + ((0) * 0x10)) + 0x00 + 3)))&0x0F)) == 0x08)
    {
# 800 "../FreeMaster_S32xx/src_common/freemaster_can.c"
        FMSTR_TxCan();
