...
#define adConv1_H 
# 75 "D:/s32dsworkspace/QLS/QLS100_S32K_X001/Generated_Code/adConv1.h"
...
# 76 "D:/s32dsworkspace/QLS/QLS100_S32K_X001/Generated_Code/adConv1.h" 2
...
# 55 "D:/s32dsworkspace/QLS/common/adsample.c"
void adsample_ADC_IRQHandler(void)
{

    ADC_DRV_GetChanResult(0U, 0U, (uint16_t *)&adcRawValue);

    adcConvDone = 1;
    FMSTR_Recorder();
    return;
}
# 72 "D:/s32dsworkspace/QLS/common/adsample.c"
void adsample_ADC_Init(void)
{
    ...
    ADC_DRV_ConfigConverter(0U, &adConv1_ConvConfig0);
    ADC_DRV_AutoCalibration(0U);
    ADC_DRV_ConfigChan(0U, 0UL, &adConv1_ChnConfig0);
    ADC_DRV_ConfigChan(0U, 1UL, &adConv1_ChnConfig1);
    ADC_DRV_ConfigChan(0U, 2UL, &adConv1_ChnConfig2);
    ...
    if (!calculateIntValue(&pdly1_InitConfig0, 1000000UL, &delayValue))
    {

        while(1);
    }

    PDB_DRV_Init((0U), &pdly1_InitConfig0);
    PDB_DRV_Enable((0U));
    PDB_DRV_ConfigAdcPreTrigger((0U), 0UL, &pdly1_AdcTrigInitConfig0);
    PDB_DRV_ConfigAdcPreTrigger((0U), 0UL, &pdly1_AdcTrigInitConfig1);
    PDB_DRV_ConfigAdcPreTrigger((0U), 0UL, &pdly1_AdcTrigInitConfig2);

    PDB_DRV_SetTimerModulusValue((0U),6000);

 PDB_DRV_SetAdcPreTriggerDelayValue((0U), 0, 0, 0);

 PDB_DRV_SetAdcPreTriggerDelayValue((0U), 0, 1, 2000);

 PDB_DRV_SetAdcPreTriggerDelayValue((0U), 0, 2, 4000);
