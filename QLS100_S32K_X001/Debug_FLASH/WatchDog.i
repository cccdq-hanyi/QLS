...
{
 ((WDOG_Type *)(0x40052000u))->CNT = 0xB480A602;
 return 0;
}
...
void v_wtd_DeInit(void)
{
 ...
 ;
 ((WDOG_Type *)(0x40052000u))->CNT = 0xD928C520;
 ((WDOG_Type *)(0x40052000u))->TOVAL = 0x0000FFFFU;
 ((WDOG_Type *)(0x40052000u))->CS &= ~0x80u;
...
{
 uint32_t CS=((WDOG_Type *)(0x40052000u))->CS;




 CS &= ~(0x8000u | 0x1000u | 0x300u | 0x40u |
              0x20u | 0x4u | 0x2u | 0x1u);
 CS |= (((uint32_t)(((uint32_t)(0))<<15u))&0x8000u);
 CS |= (((uint32_t)(((uint32_t)(0))<<12u))&0x1000u);
 CS |= (((uint32_t)(((uint32_t)(0x10))<<8u))&0x300u);
 CS |= (((uint32_t)(((uint32_t)(0))<<6u))&0x40u);
 CS |= (((uint32_t)(((uint32_t)(1))<<5u))&0x20u);
 CS |= (((uint32_t)(((uint32_t)(1))<<12u))&0x1000u);

 CS |= 0x4000u;
 CS |= 0x80u | 0x2000u;

 CS |= (((uint32_t)(((uint32_t)(1))<<2u))&0x4u);



 __asm volatile ("cpsid i" : : : "memory");;
 if(((WDOG_Type *)(0x40052000u))->CS&0x2000u)
  ((WDOG_Type *)(0x40052000u))->CNT=0xD928C520;
 else
 {
  ((WDOG_Type *)(0x40052000u))->CNT=0xC520;
  ((WDOG_Type *)(0x40052000u))->CNT=0xD928;
 }
 while(!(((((WDOG_Type *)(0x40052000u))->CS & 0x800u) >> 11u) != 0U));

 ((WDOG_Type *)(0x40052000u))->CS = CS;
 ((WDOG_Type *)(0x40052000u))->TOVAL= ((uint32_t)Period)*31;
...
{
 ((S32_SCB_Type *)(0xE000E000u)) ->AIRCR = 0x4u|(((uint32_t)(((uint32_t)(0x5FA))<<16u))&0xFFFF0000u);
 for(;;)
 {
