# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
# 57 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
...
# 55 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.h" 2
...
#define false 0
# 56 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.h" 2
...
# 57 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.h" 2
...
# 58 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.h" 2
...
# 59 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.h" 2
...
# 58 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c" 2
# 82 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
void LPSPI_Init(LPSPI_Type * base)
{
...
# 104 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
status_t LPSPI_Config(LPSPI_Type * base, const lpspi_init_config_t * config,
                               lpspi_tx_cmd_config_t * txCmdCfgSet, uint32_t * actualBaudRate)
{
    uint32_t tcrPre;
    ...
    if (LPSPI_SetMasterSlaveMode(base, config->lpspiMode) != STATUS_SUCCESS)
    {
        return STATUS_ERROR;
    }
    ...
    if (config->lpspiMode == LPSPI_MASTER)
    {
        ...
        *actualBaudRate = LPSPI_SetBaudRate(base, config->baudRate, config->lpspiSrcClk,
                                                &tcrPre);
    ...
    error = LPSPI_SetPcsPolarityMode(base, txCmdCfgSet->whichPcs, config->pcsPol);
    if(error != STATUS_SUCCESS)
    {
        return error;
    }

    error = LPSPI_SetPinConfigMode(base, LPSPI_SDI_IN_SDO_OUT, LPSPI_DATA_OUT_RETAINED, 1);
    if(error != STATUS_SUCCESS)
    {
        return error;
    }

    base->CR = base->CR | (((uint32_t)(((uint32_t)(1U))<<0u))&0x1u);


    LPSPI_SetTxCommandReg(base, txCmdCfgSet);


    LPSPI_SetRxWatermarks(base, 0U);
    LPSPI_SetTxWatermarks(base, 0U);
...
void LPSPI_GetVersionId(const LPSPI_Type * base, uint32_t * major, uint32_t * minor,
                            uint32_t * feature)
{
    *major = (base->VERID & 0xFF000000u) >> 24u;
    *minor = (base->VERID & 0xFF0000u) >> 16u;
    *feature = (base->VERID & 0xFFFFu) >> 0u;
}
# 178 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
status_t LPSPI_Disable(LPSPI_Type * base)
{
    uint32_t lpspi_tmp = base->SR;
    lpspi_tmp = (lpspi_tmp & 0x1000000u) >> 24u;
    ...
    {
        base->CR = base->CR & (~(0x1u));
        return STATUS_SUCCESS;
    }
}
# 202 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
status_t LPSPI_SetMasterSlaveMode(LPSPI_Type * base, lpspi_master_slave_mode_t mode)
{


    if (1 == LPSPI_IsModuleEnabled(base))
    {
        return STATUS_ERROR;
    }
    else
    {
        base->CFGR1 = (base->CFGR1 & (~0x1u)) | ((uint32_t)mode << 0u);
        return STATUS_SUCCESS;
    }
}
...
void LPSPI_GetFifoSizes(const LPSPI_Type * base, uint8_t * txFifoSize,
                            uint8_t * rxFifoSize)
{
    if (txFifoSize != 0L)
    {
        *txFifoSize = (uint8_t)(1U << ((base->PARAM & 0xFFu) >> 0u));
    }
    if (rxFifoSize != 0L)
    {
        *rxFifoSize = (uint8_t)(1U << ((base->PARAM & 0xFF00u) >> 8u));
    }
}
...
void LPSPI_SetFlushFifoCmd(LPSPI_Type * base, int flushTxFifo, int flushRxFifo)
{
    ...
    crValue = ((uint32_t)flushTxFifo << 8u) |
              ((uint32_t)flushRxFifo << 9u);

    base->CR |= crValue;

}
# 269 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
status_t LPSPI_ClearStatusFlag(LPSPI_Type * base, lpspi_status_flag_t statusFlag)
{
...
# 303 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
void LPSPI_SetHostRequestMode(LPSPI_Type * base,
                                  lpspi_host_request_select_t hostReqInput,
                                  lpspi_signal_polarity_t hostReqPol,
                                  int enable)
{
    ...
    cfgr0Value |= ((uint32_t)(enable)) |
                  ((uint32_t)(hostReqPol) << 1u) |
                  ((uint32_t)(hostReqInput) << 2u);

    base->CFGR0 = cfgr0Value;
}
# 329 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
status_t LPSPI_SetPcsPolarityMode(LPSPI_Type * base, lpspi_which_pcs_t whichPcs,
                                            lpspi_signal_polarity_t pcsPolarity)
{
    ...
    else
    {
        ...
        cfgr1Value = (base->CFGR1) & (~((uint32_t)1U << (8u + (uint32_t)whichPcs)));


        cfgr1Value |= (uint32_t)pcsPolarity << (8u + (uint32_t)whichPcs);
...
# 363 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
status_t LPSPI_SetMatchConfigMode(LPSPI_Type * base,
                                            lpspi_match_config_t matchCondition,
                                            int rxDataMatchOnly,
                                            uint32_t match0,
                                            uint32_t match1)
{
    ...
    {
        cfgr1Value = base->CFGR1 & ~(0x70000u);
        cfgr1Value |= ((uint32_t)matchCondition << 16u);
        base->CFGR1 = cfgr1Value;
        base->CFGR0 = (base->CFGR0 & (~0x200u)) | ((uint32_t)rxDataMatchOnly << 9u);
        base->DMR0 = match0;
        base->DMR1 = match1;
...
# 413 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
status_t LPSPI_SetPinConfigMode(LPSPI_Type * base,
                                          lpspi_pin_config_t pinCfg,
                                          lpspi_data_out_config_t dataOutConfig,
                                          int pcs3and2Enable)
{
    ...
    else
    {
        cfgr1Value = base->CFGR1 &
                     ~(0x3000000u|0x4000000u|0x8000000u);

        cfgr1Value |= ((uint32_t)(pinCfg) << 24u) |
                      ((uint32_t)(dataOutConfig) << 26u) |
                      ((uint32_t)(!pcs3and2Enable) << 27u);
...
# 458 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
uint32_t LPSPI_SetBaudRate(LPSPI_Type * base, uint32_t bitsPerSec,
                               uint32_t sourceClockInHz, uint32_t * tcrPrescaleValue)
{
    uint32_t lpspi_tmp;
    ...
    if (LPSPI_IsMaster(base) == 0)
    {
        return 0;
    }

    if (LPSPI_IsModuleEnabled(base))
    {
        return 0;
    }
    ...
    lpspi_tmp = base->CCR;
    lpspi_tmp &= ~(0xFFu);
    lpspi_tmp |= (((uint32_t)(((uint32_t)(bestScaler))<<0u))&0xFFu);
    base->CCR = lpspi_tmp;
...
# 570 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
status_t LPSPI_SetBaudRateDivisor(LPSPI_Type * base, uint32_t divisor)
{
    uint32_t lpspi_tmp;
    ...
    else
    {
        lpspi_tmp = base->CCR;
        lpspi_tmp &= ~(0xFFu);
        lpspi_tmp |= (((uint32_t)(((uint32_t)(divisor))<<0u))&0xFFu);
        base->CCR = lpspi_tmp;

        return STATUS_SUCCESS;
    }
}
# 618 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
status_t LPSPI_SetDelay(LPSPI_Type * base, lpspi_delay_type_t whichDelay, uint32_t delay)
{
    uint32_t ccrValue = 0;
...
# 660 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
void LPSPI_SetTxCommandReg(LPSPI_Type * base, const lpspi_tx_cmd_config_t * txCmdCfgSet)
{
     base->TCR = (((uint32_t)txCmdCfgSet->clkPolarity << 31u) |
                         ((uint32_t)txCmdCfgSet->clkPhase << 30u) |
                         ((uint32_t)txCmdCfgSet->preDiv << 27u) |
                         ((uint32_t)txCmdCfgSet->whichPcs << 24u) |
                         ((uint32_t)txCmdCfgSet->lsbFirst << 23u) |
                         ((uint32_t)txCmdCfgSet->byteSwap<< 22u) |
                         ((uint32_t)txCmdCfgSet->contTransfer << 21u) |
                         ((uint32_t)txCmdCfgSet->contCmd << 20u) |
                         ((uint32_t)txCmdCfgSet->rxMask << 19u) |
                         ((uint32_t)txCmdCfgSet->txMask << 18u) |
                         ((uint32_t)txCmdCfgSet->width << 16u) |
                         ((uint32_t)(txCmdCfgSet->frameSize - 1UL) << 0u));
}
# 688 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
void LPSPI_WriteDataBlocking(LPSPI_Type * base, uint32_t data)
{

    while(LPSPI_GetStatusFlag(base, LPSPI_TX_DATA_FLAG) == 0) { }
...
# 712 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
uint32_t LPSPI_ReadDataBlocking(const LPSPI_Type * base)
{

    while(LPSPI_GetStatusFlag(base, LPSPI_RX_DATA_FLAG) == 0) { }


    return base->RDR;
}
# 730 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/lpspi/lpspi_hw_access.c"
void LPSPI_SetPcs(LPSPI_Type * base, lpspi_which_pcs_t whichPcs)
{
 uint32_t regVal;

 regVal = base->TCR;
 regVal &= (uint32_t)(~(0x3000000u));
 regVal |= (uint32_t)((uint32_t)whichPcs << 24u);
 base->TCR = regVal;
}
