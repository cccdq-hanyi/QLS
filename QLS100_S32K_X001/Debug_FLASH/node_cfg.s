...
.Ltext0:
	...
	.section	.text.u8_appl_dllcanTxOk,"ax",%progbits
	.align	2
	.global	u8_appl_dllcanTxOk
	.code	16
	.thumb_func
	.type	u8_appl_dllcanTxOk, %function
u8_appl_dllcanTxOk:
.LFB0:
	.file 1 "D:/QLS/common/Node_Mgt/node_cfg.c"
	.loc 1 6 0
	.cfi_startproc
.LVL0:
	.loc 1 8 0
...
.LVL1:
	...
	.cfi_endproc
.LFE0:
	.size	u8_appl_dllcanTxOk, .-u8_appl_dllcanTxOk
	.section	.text.u8_appl_dllcanRx,"ax",%progbits
	.align	2
	.global	u8_appl_dllcanRx
	.code	16
	.thumb_func
	.type	u8_appl_dllcanRx, %function
u8_appl_dllcanRx:
.LFB1:
	.loc 1 12 0
	.cfi_startproc
...
.LVL3:
	...
	.cfi_endproc
.LFE1:
	.size	u8_appl_dllcanRx, .-u8_appl_dllcanRx
	.text
.Letext0:
...
.Ldebug_macro0:
	...
	.uleb128 0x3
	.4byte	.LASF347
	.file 3 "D:/QLS/common/Node_Mgt/node_cfg.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0x3
	.byte	0x7
...
.LASF606:
	.ascii	"D:/QLS/common/Node_Mgt/node_cfg.c\000"
.LASF605:
