# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
# 23 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
...
# 24 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c" 2
# 34 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
void EDMA_Init(DMA_Type * base)
{
    uint8_t i;
# 59 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
    uint32_t regValTemp;
    regValTemp = base->CR;
    regValTemp &= ~(0x40u);
    regValTemp &= ~(0x20000u);
...
{
    uint32_t regValTemp;
# 91 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
    regValTemp = base->CR;
    regValTemp &= ~(0x20000u);
    regValTemp |= (((uint32_t)(((uint32_t)(1U))<<17u))&0x20000u);
    base->CR = regValTemp;
    while (((base->CR & 0x20000u) >> 17u) != 0UL)
    {}
...
{
    uint32_t regValTemp;
# 116 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
    regValTemp = base->CR;
    regValTemp &= ~(0x10000u);
    regValTemp |= (((uint32_t)(((uint32_t)(1U))<<16u))&0x10000u);
    base->CR = regValTemp;
    while (((base->CR & 0x10000u) >> 16u) != 0UL)
    {}
...
void EDMA_SetErrorIntCmd(DMA_Type * base, uint8_t channel, int enable)
{
# 145 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
    if (enable)
    {
        base->SEEI = channel;
    }
...
void EDMA_SetDmaRequestCmd(DMA_Type * base, uint8_t channel,int enable)
{
# 176 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
    if (enable)
    {
        base->SERQ = channel;
    }
...
# 229 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
void EDMA_TCDClearReg(DMA_Type * base, uint8_t channel)
{
                ...
                edma_transfer_size_t srcTransferSize, edma_transfer_size_t destTransferSize)
{
    ...
    uint16_t regValTemp;
    regValTemp = (uint16_t)((((uint16_t)(((uint16_t)(srcModulo))<<11u))&0xF800u) | (((uint16_t)(((uint16_t)(srcTransferSize))<<8u))&0x700u));
    regValTemp |= (uint16_t)((((uint16_t)(((uint16_t)(destModulo))<<3u))&0xF8u) | (((uint16_t)(((uint16_t)(destTransferSize))<<0u))&0x7u));
    base->TCD[channel].ATTR = regValTemp;
}
...
void EDMA_TCDSetNbytes(DMA_Type * base, uint8_t channel, uint32_t nbytes)
{
    ...
    DevAssert(channel < (4U));
# 296 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
    if (((base->CR & 0x80u) >> 7u) != 0UL)
    {
        int mlOffNo = 0;
        if (((base->TCD[channel].NBYTES.MLOFFNO & 0x80000000u) >> 31u) == 0UL)
        {
            if (((base->TCD[channel].NBYTES.MLOFFNO & 0x40000000u) >> 30u) == 0UL)
            {
                base->TCD[channel].NBYTES.MLOFFNO = (nbytes & 0x3FFFFFFFu);
                mlOffNo = 1;
            }
        }
        if (!mlOffNo)
        {
            ...
            regValTemp = base->TCD[channel].NBYTES.MLOFFYES;
            regValTemp &= ~(0x3FFu);
            regValTemp |= (((uint32_t)(((uint32_t)(nbytes))<<0u))&0x3FFu);
            base->TCD[channel].NBYTES.MLOFFYES = regValTemp;
        }
    }
    else
...
void EDMA_TCDSetMinorLoopOffset(DMA_Type * base, uint8_t channel, int32_t offset)
{
    ...
    DevAssert(channel < (4U));
# 345 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
    if (((base->CR & 0x80u) >> 7u) != 0UL)
    {
        int mlOffNo = 0;
        if (((base->TCD[channel].NBYTES.MLOFFNO & 0x80000000u) >> 31u) != 0UL)
        ...
        if (mlOffNo)
        {
            uint32_t regValTemp;
            regValTemp = base->TCD[channel].NBYTES.MLOFFYES;
            regValTemp &= ~(0x3FFFFC00u);
            regValTemp |= (((uint32_t)(((uint32_t)(offset))<<10u))&0x3FFFFC00u);
            base->TCD[channel].NBYTES.MLOFFYES = regValTemp;
        }
    }
...
void EDMA_TCDSetChannelMinorLink(
                DMA_Type * base, uint8_t channel, uint32_t linkChannel, int enable)
{

    DevAssert(channel < (4U));
    DevAssert(linkChannel < (4U));
# 429 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K116_EAR_1.8.7/platform/drivers/src/edma/edma_hw_access.c"
    uint16_t regValTemp;
    regValTemp = base->TCD[channel].BITER.ELINKYES;
    regValTemp &= (uint16_t)~(0x8000u);
    regValTemp |= (uint16_t)(((uint16_t)(((uint16_t)(enable ? 1UL : 0UL))<<15u))&0x8000u);
    ...
    {
        regValTemp = base->TCD[channel].BITER.ELINKYES;
        regValTemp &= (uint16_t)~(0x1E00u);
        regValTemp |= (uint16_t)(((uint16_t)(((uint16_t)(linkChannel))<<9u))&0x1E00u);
        base->TCD[channel].BITER.ELINKYES = regValTemp;
...
void EDMA_TCDSetMajorCount(DMA_Type * base, uint8_t channel, uint32_t count)
{
    ...
    if ((base->TCD[channel].BITER.ELINKNO & 0x8000u) == 0x8000u)
    {
        regValTemp = base->TCD[channel].BITER.ELINKYES;
        regValTemp &= (uint16_t)~(0x1FFu);
        regValTemp |= (uint16_t)(((uint16_t)(((uint16_t)(count))<<0u))&0x1FFu);
        base->TCD[channel].BITER.ELINKYES = regValTemp;
    ...
    else
    {
        ...
        regValTemp &= (uint16_t)~(0x7FFFu);
        regValTemp |= (uint16_t)(((uint16_t)(((uint16_t)(count))<<0u))&0x7FFFu);
...
uint32_t EDMA_TCDGetCurrentMajorCount(const DMA_Type * base, uint8_t channel)
{
    ...
    if ((base->TCD[channel].BITER.ELINKNO & 0x8000u) == 0x8000u)
    {
        result = (uint16_t)((base->TCD[channel].CITER.ELINKYES & 0x1FFu) >> 0u);
    }
    else
    {
        result = (uint16_t)((base->TCD[channel].CITER.ELINKNO & 0x7FFFu) >> 0u);
    }
