...
# 1 "../Sources/CAN_Comm.h" 1
# 9 "../Sources/CAN_Comm.h"
#define CAN_COMM_H_ 
...
# 12 "../Sources/CAN_Comm.h" 2

#define RX_MAX_BUF_NUM 2

#define TX_MAILBOX (1UL)
#define TX_MSG_ID (0x111UL)

#define RX_MAILBOX (0UL)
#define RX_MSG_ID (0x222UL)
...
extern can_message_t Rx_CAN_Msg_Buffer[2];
extern uint32_t CAN_RxComplete_Flag;
extern uint8_t Rx_CAN_Msg_Buffer_Index;
# 9 "../Sources/CAN_Comm.c" 2

can_message_t Rx_CAN_Msg_Buffer[2];
...
void CAN_ISR_Callback(uint32_t instance,can_event_t eventType,uint32_t objIdx,void *driverState)
{
 switch(eventType)
 {
  case CAN_EVENT_RX_COMPLETE:
   ...
   if(Rx_CAN_Msg_Buffer_Index >= 2)
   {

    Rx_CAN_Msg_Buffer_Index = 0;
   }

   CAN_Receive(can_pal1_instance,(0UL),&Rx_CAN_Msg_Buffer[Rx_CAN_Msg_Buffer_Index]);
...
# 78 "../Sources/CAN_Comm.c"
void CAN_Comm_Init(void)
{



 PINS_DRV_ClearPins(((GPIO_Type *)(0x400FF080u)), 1<<5);


 CAN_Init(can_pal1_instance, &can_pal1_Config0);

 CAN_ConfigTxBuff(can_pal1_instance, (1UL), &buffCfg);

 CAN_ConfigRxBuff(can_pal1_instance, (0UL), &buffCfg, (0x222UL));

 CAN_InstallEventCallback(can_pal1_instance,(can_callback_t)CAN_ISR_Callback,0L);

 CAN_Receive(can_pal1_instance,(0UL),&Rx_CAN_Msg_Buffer[0]);
}
# 104 "../Sources/CAN_Comm.c"
void CAN_Transmit(uint32_t id, uint8_t* Data,uint8_t Length)
{
 ...
 CAN_Send(can_pal1_instance,(1UL),&can_message);
}
